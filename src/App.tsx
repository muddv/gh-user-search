...
export function App() {
  ...
  return (
    <div className="">
      ...
      >
        <div className="mx-auto my-5 flex">
          ...
          <input
            ...
            className="h-[45px] w-[35rem] bg-neutral-50 rounded border-2 border-gray-800 p-2 focus:shadow-md focus:outline-none"
          />
      ...
      <div className="text-slate-700 flex min-h-screen bg-gray-50 min-h-screen items-center justify-center">
